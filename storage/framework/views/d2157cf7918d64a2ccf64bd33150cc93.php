<?php $__env->startSection('title', 'KRS & Skills'); ?>
<?php $__env->startSection('page-title', 'KRS & Skills AI'); ?>
<?php $__env->startSection('page-subtitle', 'Upload KRS untuk deteksi skill otomatis dengan AI'); ?>
...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="p-5 <?php echo e($statusConfig['bg']); ?> border rounded-xl flex items-center gap-4">
        <div class="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center flex-shrink-0">
            <i class="fas <?php echo e($statusConfig['icon']); ?> text-xl <?php echo e($statusConfig['iconColor']); ?>"></i>
        </div>
        <div class="flex-1">
            <p class="font-semibold text-white"><?php echo e($statusConfig['title']); ?></p>
            <p class="text-sm text-gray-400 mt-0.5"><?php echo e($statusConfig['desc']); ?></p>
        </div>
        <?php if($krsStatus === 'parsed'): ?>
        <div class="text-right flex-shrink-0">
            <div class="text-2xl font-black text-accent-400"><?php echo e($student?->skills->count() ?? 0); ?></div>
    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="card p-6">
            ...
            <form action="<?php echo e(route('student.krs.upload')); ?>" method="POST" enctype="multipart/form-data" id="krsForm">
                <?php echo csrf_field(); ?>
                <div id="dropzone"
                ...
                <div class="mt-4 p-4 bg-white/3 rounded-xl border border-white/5">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['Python', 'Machine Learning', 'Data Analysis', 'Web Dev', 'SQL', 'Statistics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="text-xs px-2 py-1 bg-primary-500/10 text-primary-400 rounded-full border border-primary-500/20 opacity-40"><?php echo e($skill); ?></span>
            ...
            <?php if($krsStatus === 'parsed'): ?>
            <form action="<?php echo e(route('student.krs.reparse')); ?>" method="POST" class="mt-3">
                <?php echo csrf_field(); ?>
        ...
        <div class="card p-6">
            ...
            <?php if(!$student?->skills || $student->skills->isEmpty()): ?>
            ...
            <?php else: ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $student->skills->sortByDesc('proficiency_level'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-3 bg-white/3 rounded-xl border border-white/5">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-white"><?php echo e($skill->skill_name); ?></span>
                    ...
                    <div class="progress-bar h-1.5">
                        <div class="progress-fill
                            <?php if($skill->proficiency_level >= 4): ?> bg-gradient-to-r from-accent-500 to-accent-400
                            <?php elseif($skill->proficiency_level >= 2): ?> bg-gradient-to-r from-yellow-600 to-yellow-400
                            <?php else: ?> bg-gradient-to-r from-gray-600 to-gray-500 <?php endif; ?>"
                            style="width: <?php echo e(min(($skill->proficiency_level / 5) * 100, 100)); ?>%">
                        </div>
                    </div>
                    <?php if($skill->source_courses && count($skill->source_courses) > 0): ?>
                    <p class="text-[10px] text-gray-600 mt-1.5">
                        Dari: <?php echo e(implode(', ', array_slice($skill->source_courses, 0, 2))); ?>
    ...
    <div class="card p-6">
        ...
        <div class="grid sm:grid-cols-3 gap-4">
            ...
            <div class="flex gap-4">
                <div class="w-10 h-10 bg-<?php echo e($step['color']); ?>-500/20 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                    <i class="fas <?php echo e($step['icon']); ?> text-<?php echo e($step['color']); ?>-400"></i>
                </div>
                <div>
                    <p class="text-sm font-semibold text-white"><?php echo e($step['title']); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\SkillSync\resources\views/student/krs.blade.php ENDPATH**/ ?>