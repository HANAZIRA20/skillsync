...
<div class="glass rounded-2xl p-8 animate-fade-in shadow-2xl shadow-primary-950/50">
    ...
    <?php if($errors->any()): ?>
        <div class="mb-6 p-4 bg-red-900/40 border border-red-500/50 rounded-xl">
            <p class="text-red-300 text-sm"><?php echo e($errors->first()); ?></p>
        </div>
    <?php endif; ?>
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-500 text-sm">Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-primary-400 font-semibold hover:text-primary-300 transition-colors">Daftar Sekarang</a>
        </p>
    </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\SkillSync\resources\views/auth/login.blade.php ENDPATH**/ ?>